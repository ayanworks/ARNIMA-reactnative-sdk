...
class Agent {
  ...
  connectWithMediator = async (
    url: string,
    apiType: string,
    apiBody: string,
  ) => {
    try {
      const response = await ConnectWithMediatorService.ConnectWithMediator(
        url,
        apiType,
        apiBody,
      );
  ...
  updateMediator = async (url: string, apiType: string, apiBody: string) => {
    try {
      return await ConnectWithMediatorService.updateMediator(
        url,
        apiType,
        apiBody,
      );
  ...
  deleteWallet = async () => {
    try {
      ...
      console.log('Agent - Delete wallet error = ', error);
      throw error;
    }
  };
  ...
  selectDefaultPool = async (poolName: string) => {
    try {
      return await PoolService.selectDefaultPool(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        poolName,
      );
  ...
  deleteAllPools = async () => {
    try {
      return await PoolService.deleteAllPools(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
      );
    } catch (error) {
  ...
  createInvitation = async (didJson: Object, logo: string) => {
    try {
      return await ConnectionService.createInvitation(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        didJson,
        logo,
  ...
  deleteConnection = async (connectionId: string) => {
    try {
      const records = await WalletStorageService.getWalletRecordsFromQuery(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
  ...
  getIssueCredentialByConnectionId = async (connectionId: string) => {
    try {
      ...
      console.log(
        'Agent - Get issue credential by connection id error = ',
        error,
      );
      throw error;
    }
  ...
  getIssueCredentialByCredentialsId = async (referent: string) => {
    try {
      return await WalletStorageService.getWalletRecordFromQuery(
        ...
        JSON.parse(this.wallet.walletCredentials),
        RecordType.Credential,
        JSON.stringify({ credentialsId: referent }),
      );
    } catch (error) {
      console.log(
        'Agent - Get all issue credential by credentials id error = ',
        error,
      );
      throw error;
    }
  ...
  acceptCredentialOffer = async (
    ...
    try {
      ...
      const response: Boolean = await CredentialService.createRequest(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        inboundMessage,
      );
  ...
  storeCredential = async (
    ...
    try {
      ...
      message = JSON.stringify(message);
      inboundMessage['message'] = message;
      const response: Boolean = await CredentialService.processCredential(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        inboundMessage,
      );
  ...
  sendBasicMessage = async (message: string, connectionId: string) => {
    try {
      return await BasicMessageService.send(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        message,
        connectionId,
  ...
  sendOutOfBandProof = async (
    inboundMessage: InboundMessage,
    revealAttributes: boolean,
    presentationObj: object,
  ) => {
    try {
      const response: Boolean = await PresentationService.createPresentation(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        inboundMessage,
        revealAttributes,
  ...
  verifyProof = async (messageId: string, inboundMessage: InboundMessage) => {
    try {
      ...
      message = JSON.stringify(message);
      inboundMessage['message'] = message;
      const response = await PresentationService.verifyProof(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        messageId,
        inboundMessage,
  ...
  sendPresentProofRequest = async (
    connectionId: string,
    proofRequest: object,
    comment: string,
  ) => {
    try {
      return await PresentationService.createRequest(
        JSON.parse(this.wallet.walletConfig),
        JSON.parse(this.wallet.walletCredentials),
        connectionId,
        proofRequest,
  ...
  getAllActionMessagesByMessageId = async (messageId: string) => {
    try {
      ...
      console.log(
        'Agent - Get all action messages by message id error = ',
        error,
      );
      throw error;
    }
